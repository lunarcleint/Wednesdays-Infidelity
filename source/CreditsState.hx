...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Box Funkin Team'],
			['Jhaix',		'jhaix',		'Director & creator of the mod, musician. Charter of Unknown Suffering.',					'https://twitter.com/Jhaix3',	'DDDDDD'],
			['Cape',		'Cape',		'Co Director of the mod, coder. Charter of Wistfulness & Dejection.',					'https://twitter.com/capeletin1',	'2F2F3A'],
			['Zero Animation',		'piola',		'Animator and artist of the mod.',					'https://twitter.com/zero_artist02',	'194419'],
			['ZetaE',		'zetas',		'Background Artist.',					'https://twitter.com/ZetaE18',	'DDDDDD'],
			['Nugget',		'nuggets',		'Logo artist and extras.',					'https://twitter.com/NuggetNightmare',	'841A4A'],
