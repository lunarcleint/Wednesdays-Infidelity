...
class VCRDistortionEffect extends Effect
{
  ...
  public function new(glitchFactor:Float,distortion:Bool=true,perspectiveOn:Bool=true,vignetteMoving:Bool=true, chromAbr:Bool = true, staticEffect:Bool = true){
  ...
  public function setChrom(state:Bool){
    shader.chrom.value[0] = state;
  }
}
